...
# lowercase, and thus it is nesisay to add additional information
...
import string
import sys
# gets an input as a comand line argument indicating what problem file to use
PROBLEM_FILE = str(sys.argv[1])
# gets an input as a comand line argument indicating the output file
...
while line:
	...
	lineCount +=1
	line = f.readline()
# Write ouput to the  output file and close the files in use
print(output)
o.write(output)
o.close()
f.close()
