...
(define (problem pb1)
  ...
  (:domain CS170)
(:objects TA_XW_h_e_e_l_e_r TA_XC_a_m_p_a_n_i_l_e TA_XC_o_r_y TA_XRSF XS_o_d_a XD_w_i_n_e_l_l_e XW_h_e_e_l_e_r XC_a_m_p_a_n_i_l_e XC_o_r_y XRSF XB_a_r_r_o_w_s )
(:init(= (total-cost) 0)
( Car_At XS_o_d_a )
