...
# Takes the adjacency matrix and reads it line by line into a 2d list
...
def makeInCar():
	...
	for ta in ta_homes:
		out += "(InCar TA_"+ta+")\n"
	return out
# Majority of problem file, takes adjacency matrix and for each edge
# in that graph creates 4 statements
# 1&2) indicates that there is a path from a->b and b->
# 3&4) adds a distance variable indicating the weight of the previous two edges
...
def makeEmptyHome():
	...
	for home in ta_homes:
		out += "(EmptyHome " +home+")\n"
	return out 
# add the goal of having all the homes be occupied
